...
const connectionOptions = {
    ...
    mobile: MethodMobile,
    browser: opcion === '1' ? ['THE MYSTIC-BOT-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['THE MYSTIC-BOT-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
    auth: {
        creds: state.creds,
...
setInterval(async () => {
  ...
  const bio = `• Activo: ${uptime} | THE MYSTIC-BOT-MD`;
