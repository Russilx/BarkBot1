...
export async function before(m, {conn, participants}) {
  ...
  const pp = await conn.profilePictureUrl(m.chat, 'image').catch((_) => null) || 'https://raw.githubusercontent.com/Russilx/THE MYSTIC-BOT-MD/master/src/avatar_contact.png';
